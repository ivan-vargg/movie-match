...
<body class="antialiased">
    <div class="content">
        <div class="flex justify-center mt-5">
            <div class="max-w-sm mx-4 overflow-hidden bg-white rounded shadow-lg">
                <div class="px-6 py-4">
            ...
            <div class="max-w-sm mx-4 overflow-hidden bg-white border-4 border-yellow-500 rounded shadow-lg">
